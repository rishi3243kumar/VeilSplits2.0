...
- 📊 **Pitch Deck (PDF):** [docs/pitch_deck.pdf](https://github.com/rishi3243kumar/VeilSplits2.0/blob/main/docs/pitch_deck.pdf)
- 📊 **Verifiable On-Chain Proof (67 Wallets):** [docs/real_user_proof.md](https://github.com/rishi3243kumar/VeilSplits2.0/blob/main/docs/real_user_proof.md) *(Copy and verify transaction hashes directly on the Stellar Testnet ledger)*
- 🔍 **Live Stellar Expert Ledger Proof:** [Verify 67 Active Wallet Transactions on Stellar Expert](https://stellar.expert/explorer/testnet/account/GDWE3AJB67FJWMQ6RM7JQ6KF6HSA42VYDGFYJNGVT7SQZPUAB6MXEZRW)
...
- 📊 **Pitch Deck (PDF):** [docs/pitch_deck.pdf](https://github.com/rishi3243kumar/VeilSplits2.0/blob/main/docs/pitch_deck.pdf)
- 📝 **Pitch Deck Content (Markdown):** [docs/pitch_deck_content.md](https://github.com/rishi3243kumar/VeilSplits2.0/blob/main/docs/pitch_deck_content.md)
...
We have successfully onboarded **67 unique active wallets** on the Stellar Testnet. 

🌐 **[CLICK HERE TO VERIFY ALL 67 INCOMING TRANSACTIONS LIVE ON STELLAR EXPERT](https://stellar.expert/explorer/testnet/account/GDWE3AJB67FJWMQ6RM7JQ6KF6HSA42VYDGFYJNGVT7SQZPUAB6MXEZRW)**

👉 **[CLICK HERE TO VIEW THE FULL LIST OF ALL 67 VERIFIABLE TRANSACTIONS (LOCAL MD PROOF)](https://github.com/rishi3243kumar/VeilSplits2.0/blob/main/docs/real_user_proof.md)**

### On-Chain Transaction Proof Screenshot (Stellar Expert):
![steller expert transaction](image-3.png)

Below is a sample of 5 verifiable on-chain transactions generated by these active wallets:
...
- **On-chain Data Export (Markdown):** [docs/real_user_proof.md](https://github.com/rishi3243kumar/VeilSplits2.0/blob/main/docs/real_user_proof.md) *(Copy and verify transaction hashes directly on the Stellar Testnet ledger)*
- **On-chain Data Export (CSV):** [docs/real_user_proof.csv](https://github.com/rishi3243kumar/VeilSplits2.0/blob/main/docs/real_user_proof.csv)
...
|---|---|---|---|---|---|---|
| USR-01 | Vivek Kumar | `Vivekku3411m@gmail.com` | `GDPHORC6UKASNY7WMIW23IOUA2LY5SNENO367O4R6WV7Q7GNJW3WWI27` | Requested adding a light/dark theme switch in the header | Added a light/dark theme toggle to the header component | [df95870](https://github.com/rishi3243kumar/VeilSplits/commit/df95870) |
| USR-02 | Shivan Raj | `Shivamraj20053@gmail.com` | `GBAJGNCG4MVPDMJBG6YVEKAW7EFUEO3NYBCSWYD7RB7IY32LI2GXFIWV` | Suggested adding a copy button next to wallet addresses | Integrated a one-click copy icon next to all wallet inputs | [33612eb](https://github.com/rishi3243kumar/VeilSplits/commit/33612eb) |
| USR-03 | Vinod Kumar Sharma | `vinodkrsharma728@gmail.com` | `GAYQ4MOJPRPXMHIRLWU6KNS7EK67BBIKYWVO5QMCJWZ67JO3WMVBINWL` | Requested social media share buttons for Twitter/WhatsApp | Added social share buttons to dashboard profiles | [947d3f5](https://github.com/rishi3243kumar/VeilSplits/commit/947d3f5) |
| USR-04 | Rahul Mehta | `Rahulmehtaaa56@gmail.com` | `GASTVZNEON3OSJ5R5YOELNWY7O622OYZ74XWOEQJOUAFPFPDBWEM45US` | Suggested popup toast notifications for transaction alerts | Replaced standard browser alerts with hot-toast notifications | [d777b6c](https://github.com/rishi3243kumar/VeilSplits/commit/d777b6c) |
| USR-05 | Geeta devi | `geetadevi827@gmail.com` | `GC24SKGDV66ST63KDMZBJNFOTR63NVXN2GBLFLKYXECUKWZZ4TENPJRP` | Requested a keyboard shortcut to connect wallet | Added quick keyboard listener for wallet connection | [4899c64](https://github.com/rishi3243kumar/VeilSplits/commit/4899c64) |
| USR-06 | Sumit Baul | `sumit2006baul@gmail.com` | `GBH45ZRZUNV5RIMDF4IQLSJWFIFEX5KPRJSYEPV5QZCPE6XP77BCSPWD` | Suggested showing the last 5 created bills on dashboard | Created a Recent Activity list section on the dashboard | [21d6d10](https://github.com/rishi3243kumar/VeilSplits/commit/21d6d10) |
| USR-07 | Ritesh kant | `riteshkantbalatua@gmail.com` | `GDPHORC6UKASNY7WMIW23IOUA2LY5SNENO367O4R6WV7Q7GNJW3WWI27` | Requested skeleton loading states for balances | Replaced spinners with styled skeleton card loaders | [2c5f467](https://github.com/rishi3243kumar/VeilSplits/commit/2c5f467) |
| USR-08 | Reena Kumari | `reenakumari8376@gmail.com` | `GDKEIJKOFWCR4VZP3GVDUSKBI6SXHCGVXMR4YETJ54EB7BJ6RESNNJ4A` | Suggested adding a friendly empty state illustration | Added empty dashboard placeholder layout illustration | [21d6d10](https://github.com/rishi3243kumar/VeilSplits/commit/21d6d10) |

## Product Improvements This Level

Based on Level 4 feedback, we shipped the following key improvements:

- Fixed confusing recipient input by adding an Address Book and Equal Split Calculator → [commit fccac4d](https://github.com/rishi3243kumar/VeilSplits/commit/fccac4d)
- Solved confusion around claiming funds by adding one-click "Pay Now" Deep Links for stealth addresses → [commit fccac4d](https://github.com/rishi3243kumar/VeilSplits/commit/fccac4d)
- Reduced drop-off by condensing the multi-step welcome modal into a single, streamlined Onboarding Flow → [commit fccac4d](https://github.com/rishi3243kumar/VeilSplits/commit/fccac4d)
- Replaced internal mock rating system with a direct Google Form feedback link → [commit fccac4d](https://github.com/rishi3243kumar/VeilSplits/commit/fccac4d)
- Expanded admin telemetry to track the milestone of 50+ users and conversion funnels → [commit 1af05a9](https://github.com/rishi3243kumar/VeilSplits/commit/1af05a9)
